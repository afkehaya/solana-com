...
- **Flexible Infrastructure Options**: Deploy your SPE, validators, and RPC nodes across your infrastructure yourself with [SVMKit](https://github.com/abklabs/svmkit-examples/tree/main/aws-network-spe-py) or work with managed service providers like Triton One, Syndica, or Helius.

- **Realistic Development & Testing Environments**: SPEs provide production-like environments for testing programs, plugins (e.g., yellowstone-gRPC), and infrastructure workflow, without exposing work-in-progress to the public network.
...
locally for testing and development, or within custom infrastructure leveraging open source tools like [SVMKit](https://github.com/abklabs/svmkit-examples/tree/main/aws-network-spe-py). You can
also utilize some managed services providers such as [Helius](https://www.helius.dev/),
[Triton](https://triton.one/), or [Edgevana](https://www.edgevana.com/) to
deploy your SPE.

## How to get started with SPEs

ABK labs, the maintainer of [SVMKit](https://github.com/abklabs/svmkit-examples/tree/main/aws-network-spe-py) has provided a demo for  for deploying a configurable SPE in AWS using pulumi.
